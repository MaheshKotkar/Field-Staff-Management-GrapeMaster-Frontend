...
const NotificationBell = () => {
    ...
    const fetchNotifications = useCallback(async () => {
        ...
        try {
            ...
            // Filter: staff only sees 'rejection' notifications, admin sees everything
            const filteredData = user.role === 'admin' 
                ? data 
                : data.filter(n => n.type === 'rejection');
    ...
    const handleNotificationClick = (notification) => {
        ...
        switch (notification.type) {
            case 'rejection':
                navigate('/visits', { state: { editVisitId: notification.metadata?.visitId } });
                break;
            case 'farmer':
                navigate('/farmers');
                break;
    ...
    const getIcon = (type) => {
        switch (type) {
            case 'rejection': return <MapPin size={18} />;
